...
def iterative_placement(Psi,n,signal_sparsity,n_sensors,roi_idx,variance_threshold_ratio):
...
if __name__ == '__main__':
    ...
    """
        A-optimality sensor placement criteria:
            - trace miniimization
    ...
    if sensor_placement_rois:
        ...
        algorithm = 'JB_worst_variance'#['JB_trace','JB','JB_worst_variance','JB_feasibility_program']
        ...
        locations = [sensor_placement.locations[1],[i for i in np.arange(n) if i not in sensor_placement.locations[1]]]
        # run in case you want to see what happens if ROI thresholds are not controlled
        # sensor_placement = simple_placement(Psi,n,signal_sparsity,len(locations[0]))
